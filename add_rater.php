            ...
            <section class="col-lg-12 col-md-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        ...
                        <center>
                            <form method="post" action="/../build/php/inc.php" id="addraterkeshvari" onsubmit="return validateaddraterkeshvari()">

                                <table class="tableratermanager">
                                    <tr>
                                        <th>کد ارزیاب (نام کاربری)</th>
                                        <td><input class="inputratermanager" type="text" name="code" id="username"></td>
                                    </tr>
                                    <tr>
                                        <th>رمز عبور</th>
                                        <td><input  class="inputratermanager" type="text" name="password" id="password"></td>
                                    </tr>
                                    <tr>
                                        <th>نام</th>
                                        <td><input class="inputratermanager" type="text" name="name" id="name"></td>
                                    </tr>
                                    <tr>
                                        <th>نام خانوادگی</th>
                                        <td><input class="inputratermanager" type="text" name="family" id="family"></td>
                                    </tr>
                                    <tr>
                                        <th>جنسیت</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th>سطح علمی</th>
                                        <td>
                                            <select name="sath_elmi" id="sathelmi">
                                    ...
                                    <tr>
                                        <th>تلفن</th>
                                        <td><input  class="inputratermanager" type="text" name="phone" id="phone"></td>
                                    </tr>
                                    <tr>
                                        <th>آدرس</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="bankname">
                                                <option selected>انتخاب کنید</option>
                                                <?php
                                                $querybank=mysqli_query($connection,"select * from `bank_list`");
                                ...
                                <br/>
                                    <input name="addraterkeshvari" class="set" type="submit" value="ثبت" onclick="return confirm('کاربر گرامی: لطفا در صورت صحت اطلاعات ارزیاب جدید، بر روی گزینه OK کلیک کنید')">
                ...
                <div class="box-body">
                    <center>
                        <table class="arzyabinashodetable">
                            ...
                            <?php
                            $resultraters=mysqli_query($connection,"select * from rater_list where `type`=0 and city_name is null order by family asc");
...
<script>
    function validateaddraterkeshvari(){
        var username = document.forms["addraterkeshvari"]["username"].value;
        var password = document.forms["addraterkeshvari"]["password"].value;
        var name = document.forms["addraterkeshvari"]["name"].value;
        var family = document.forms["addraterkeshvari"]["family"].value;
        var gender = document.forms["addraterkeshvari"]["gender"].value;
        var sathelmi = document.forms["addraterkeshvari"]["sathelmi"].value;
        var phone = document.forms["addraterkeshvari"]["phone"].value;
        if (username==''){
            ...
            return false;
        }else if (gender=="انتخاب کنید"){
            alert("جنسیت را انتخاب نمایید");
            return false;
        }else if (sathelmi=="انتخاب کنید"){
            alert("سطح علمی را انتخاب نمایید");
            return false;
        }else if (phone==''){
            alert("شماره همراه را وارد نمایید");
            return false;
        }else{
            return true;
        }
