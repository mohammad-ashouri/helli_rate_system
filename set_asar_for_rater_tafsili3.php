                    ...
                    <section class="col-lg-12 col-md-12">
                        <div class="box box-solid box-danger">
                            <div class="box-header">
                                ...
                                <center>
                                    <h3 class='box-title'>
                                        خطا در حذف اثر از پنل ارزیاب (مشکل در پیدا کردن کد اثر مربوطه)
                                    </h3>
                                </center>
                            </div>
                    </section>
                                            ...
                                            <center>
                                                <form method="post" action="build/php/inc.php"
                                                    ...
                                                    switch ($_SESSION['head']) {
                                                        case 1:
                                                            ?>
                                                            <input name="rft3k" type="submit"
                                                                   value="حذف اثر از پنل ارزیاب"
                                                                   style="padding: 5px; font-weight: bold">
                                                            <?php break;
                                                        case 2: ?>
                                                            <input name="rft3o" type="submit"
                                                                   value="حذف اثر از پنل ارزیاب"
                                                                   style="padding: 5px; font-weight: bold">
                                                            <?php break;
                                                        case 3: ?>
                                                            <input name="rft3m" type="submit"
                                                                   value="حذف اثر از پنل ارزیاب"
                                                                   style="padding: 5px; font-weight: bold">
                                                            <?php break;
                                                    }
                                                    if ($_SESSION['head'] == 0 and (@$_SESSION['city'] == 'قم' or @$_SESSION['groupname'] != null)):
                                                        ?>
                                                        <input name="rft3o" type="submit" value="حذف اثر از پنل ارزیاب"
                                                               style="padding: 5px; font-weight: bold">
                                                    <?php endif; ?>
                                                </form>
                                            </center>
                                                                ...
                                                                <div class="box box-solid box-warning">
                                                                    <div class="box-header">
                                                                        ...
                                                                        <h3 class='box-title'>لیست آثار راه یافته به
                                                                            مرحله تفصیلی سوم برای اختصاص به ارزیاب</h3>
                                                                        <!-- tools box -->
                                                                        ...
                                                                        <table id="myTable3"
                                                                            ...
                                                                            switch ($_SESSION['head']) {
                                                                                case 1:
                                                                                    ...
                                                                                    break;
                                                                                case 2:
                                                                                    $resultat3 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where ((etelaat_p.master='نیست' and etelaat_p.ostantahsili='$state') or (etelaat_p.master='هست' and etelaat_p.teachingProvince='$state')) and etelaat_a.nobat_arzyabi_ostani='تفصیلی سوم' and etelaat_a.bargozideh_ostani='نمی باشد' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and etelaat_a.approve_sianat=0 and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                                                    break;
                                                                                case 3:
                                                                                    $resultat3 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where (etelaat_p.master='نیست' and etelaat_p.ostantahsili='$state' and etelaat_p.shahrtahsili='$city' and etelaat_p.madrese='$school') and etelaat_p.madrese='$school' and etelaat_a.nobat_arzyabi_madrese='تفصیلی سوم' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and etelaat_a.approve_sianat=0 and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                                                    break;
                                                                            }
                                                                            if ($_SESSION['head'] == 0 and $_SESSION['groupname'] != null) {
                                                                                $resultat3 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where  ((etelaat_p.master='نیست' and etelaat_p.ostantahsili='قم') or (etelaat_p.master='هست' and etelaat_p.teachingProvince='قم')) and etelaat_a.nobat_arzyabi_ostani='تفصیلی سوم' and etelaat_a.bargozideh_ostani='نمی باشد' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and etelaat_a.groupelmi='$groupname' and etelaat_a.approve_sianat=0 and etelaat_p.master='نیست' and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                                            }
                                                                            $a = 1;
                                                                                        ...
                                                                                        switch ($_SESSION['head']) {
                                                                                            case 1:
                                                                                                if ($bin['codearzyabtafsili2'] != null or $bin['codearzyabtafsili2'] != '') {
                                                                                                    $tafsili2grade = mysqli_query($connection, "select * from tafsili2 where codeasar='$codeasar'");
                                                                                                    foreach ($tafsili2grade as $item) {
                                                                                                    }
                                                                                            ...
                                                                                            case 2:
                                                                                            case 0:
                                                                                                $tafsili2grade = mysqli_query($connection, "select * from tafsili2_ostan where codeasar='$codeasar'");
                                                                                                foreach ($tafsili2grade as $item) {
                                                                                                }
                                                                                                $t2ratercode = $item['rater_id'];
                                                                                                $query = mysqli_query($connection, "select * from rater_list where code='$t2ratercode'");
                                                                                                foreach ($query as $t2rater) {
                                                                                                }
                                                                                                echo $t2rater['name'] . ' ' . $t2rater['family'] . ' - ' . $item['jam'];
                                                                                                break;
                                                                                            case 3:
                                                                                                $tafsili2grade = mysqli_query($connection, "select * from tafsili2_madrese where codeasar='$codeasar'");
                                                                                                foreach ($tafsili2grade as $item) {
                                                                                                }
                                                                                                $t2ratercode = $item['rater_id'];
                                                                                                $query = mysqli_query($connection, "select * from rater_list where code='$t2ratercode'");
                                                                            ...
                                                                            case 1:
                                                                                ...
                                                                                <script>
                                                                                    function sendcode(coderater, codeasar) {
                                                                                        ...
                                                                                        xmlhttp.open("GET", "/build/ajax/sett3k.php?ratercode=" + coderater + "&codeasar=" + codeasar, true);
                                                                                        xmlhttp.send();
                                                                                    }
                                                                                </script>
                                                                            <?php break;
                                                                            case 2:case 0: ?>
                                                                                <script>
                                                                                    function sendcode(coderater, codeasar) {
                                                                                        var xmlhttp = new XMLHttpRequest();
                                                                                        xmlhttp.open("GET", "/build/ajax/sett3o.php?ratercode=" + coderater + "&codeasar=" + codeasar, true);
                                                                                        xmlhttp.send();
                                                                                    }
                                                                                </script>
                                                                            <?php break;
                                                                            case 3: ?>
                                                                                <script>
                                                                                    function sendcode(coderater, codeasar) {
                                                                                        var xmlhttp = new XMLHttpRequest();
                                                                                        xmlhttp.open("GET", "/build/ajax/sett3m.php?ratercode=" + coderater + "&codeasar=" + codeasar, true);
                                                                                        xmlhttp.send();
                                                                                    }
                                                                                </script>
                                                                                <?php break;
