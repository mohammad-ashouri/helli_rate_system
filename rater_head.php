                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'اخلاق و تربیت')">
                                                ...
                                                ?>
                                                <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='اخلاق و تربیت'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'ادبیات')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='ادبیات'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'اصول فقه')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='اصول فقه'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'تاریخ اسلام')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='تاریخ اسلام'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'تفسیر و علوم قرآنی')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='تفسیر و علوم قرآنی'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'علوم انسانی')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='علوم انسانی'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'علوم حدیث و درایه')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='علوم حدیث و درایه'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'فقه و حقوق اسلامی')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='فقه و حقوق اسلامی'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'فلسفه و منطق')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='فلسفه و منطق'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select onchange="sendcode(this.value,'کلام')">
                                                ...
                                                foreach ($raters as $ratersinfo):
                                                    ?>
                                                    <option <?php if ($ratersinfo['GroupNameIfGroupHead']=='کلام'){echo 'selected';} ?> value="<?php echo $ratersinfo['username'] ?>">
                                                        <?php echo $ratersinfo['family'].' - '.$ratersinfo['name'].' - کد= '.$ratersinfo['username']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
