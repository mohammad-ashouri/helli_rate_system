                                                    ...
                                                    <table id="myTable3" class="arzyabinashodetable">
                                                        ...
                                                        switch ($_SESSION['head']) {
                                                            case 1:
                                                                ...
                                                                break;
                                                            case 2:
                                                                $resultat1 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where ((etelaat_p.master='نیست' and etelaat_p.ostantahsili='$state') or (etelaat_p.master='هست' and etelaat_p.teachingProvince='$state')) and etelaat_a.nobat_arzyabi_ostani='تفصیلی اول' and etelaat_a.bargozideh_ostani='نمی باشد' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and etelaat_a.approve_sianat=0 and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                                break;
                                                            case 3:
                                                                $school = $_SESSION['school'];
                                                                $resultat1 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where (etelaat_p.master='نیست' and etelaat_p.ostantahsili='$state' and etelaat_p.shahrtahsili='$city' and etelaat_p.madrese='$school') and etelaat_a.nobat_arzyabi_madrese='تفصیلی اول' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and etelaat_a.approve_sianat=0 and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                                break;
                                                        }
                                                        if (@$_SESSION['head'] == 0 and @$_SESSION['groupname'] != null) {
                                                            $resultat1 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where ((etelaat_p.master='نیست' and etelaat_p.ostantahsili='قم') or (etelaat_p.master='هست' and etelaat_p.teachingProvince='قم')) and etelaat_a.nobat_arzyabi_ostani='تفصیلی اول' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and etelaat_a.groupelmi='$groupname' and etelaat_a.approve_sianat=0 and etelaat_p.master='نیست' and etelaat_a.sharayetavalliehsherkat='دارد' order by etelaat_a.groupelmi asc");
                                                        }
