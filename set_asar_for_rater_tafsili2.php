                                                                        ...
                                                                        <table id="myTable3"
                                                                            ...
                                                                            switch ($_SESSION['head']) {
                                                                                ...
                                                                                case 2:
                                                                                    ...
                                                                                    break;
                                                                                case 3:
                                                                                    $resultat2 = mysqli_query($connection, "SELECT * FROM `etelaat_a` INNER join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where (etelaat_p.master='نیست' and etelaat_p.ostantahsili='$state' and etelaat_p.shahrtahsili='$city' and etelaat_p.madrese='$school') and etelaat_p.madrese='$school' and etelaat_a.nobat_arzyabi_madrese='تفصیلی دوم' and etelaat_a.approve_sianat=0 and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' order by etelaat_a.groupelmi asc");
                                                                                    break;
                                                                            }
