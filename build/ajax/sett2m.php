...
<?php
	...
	$codeasar=$_GET['codeasar'];
		...
		mysqli_query($connection,"update etelaat_a set codearzyabtafsili2_madrese='$user',tahvilasararzyabitafsili2_madrese='$date',registrant_tafsili2_madrese='$registrar' where codeasar='$codeasar'");
        ...
        $operation="set asar tafsili2 madrese";
