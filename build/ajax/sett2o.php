...
//	if ($item!=null){
		mysqli_query($connection,"update etelaat_a set codearzyabtafsili2_ostani='$user',tahvilasararzyabitafsili2_ostani='$date',registrant_tafsili2_ostani='$registrar' where codeasar='$codeasar'");
        ...
        $operation="set asar tafsili2 ostan";
