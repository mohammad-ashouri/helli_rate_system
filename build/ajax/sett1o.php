...
mysqli_query($connection, "update etelaat_a set codearzyabtafsili1_ostani='$user',tahvilasararzyabitafsili1_ostani='$date',registrant_tafsili1_ostani='$registrar' where codeasar='$codeasar'");
...
$operation = "set asar tafsili1 ostan";
