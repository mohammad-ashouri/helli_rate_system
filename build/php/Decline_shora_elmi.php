...
if (isset($_POST['decline_asar']) and !empty($_POST['codeasar'])) {
    $operation = "decline_asar_shora_elmi";
    ...
    mysqli_query($connection, "update etelaat_a set approve_sianat=2,approver_sianat='$user',ellatnadashtansharayet='عدم انتخاب توسط شورای علمی',sharayetavalliehsherkat='ندارد',vaziatpazireshasar='پذیرش نشد' where codeasar='$codeasar'");
    header("location:" . $main_website_url . "/../../Send_To_Secretariat.php?success_shora_decline&codeasar=$codeasar&nameasar=$nameasar");
