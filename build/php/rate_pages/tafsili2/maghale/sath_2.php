<form method="post" action="inc_t2.php" id="myform" onsubmit="return validateForm()">
    <div class="box-body">
        ...
        <?php else: ?>
            ...
            <?php if ($_POST['subjection']=='editt2o' or $_POST['subjection']=='editt2m' or $_POST['subjection']=='tafsili2_ostan_log' or $_POST['subjection']=='tafsili2_madrese_log'): ?>
                <tr>
                    <td style="padding-top: 8px">
                        <label>
...
<script src="build/js/rateforms/t2/m2.js"></script>