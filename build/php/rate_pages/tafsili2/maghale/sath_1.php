        ...
        <center>
            <table class="tabletafsili" >
                ...
                <tr>
                    ...
                    <td>
                        <input <?php if($_POST['subjection']=='log'){echo 'disabled';} ?> id="t13" type="number" step="any" name="t13" class="rate_inputs" onblur="calcular()" value="<?php if($_POST['subjection']=='log' or $_POST['subjection']=='editt2'){echo $tafsili2items['dastyabibeahdaf'];} ?><?php if ($_POST['subjection']=='editt2o' or $_POST['subjection']=='editt2m' or isset($_POST['tafsili2_ostan_log']) or isset($_POST['tafsili2_madrese_log'])){echo @$item['dastyabibeahdaf'];} ?>">
                        &nbsp;&nbsp;
                        از 4
                    </td>
                </tr>
            ...
            <center>
	            ...
	            <?php if ($_POST['subjection']==null): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2maghale" value="ثبت ارزیابی">
                    </p>
	            <?php elseif ($_POST['subjection']=='statet2'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2maghaleostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='schoolt2'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2maghalemadrese" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='editt2'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2maghale" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt2o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2maghaleostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt2m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2maghalemadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t2/m1.js"></script>