            ...
            <center>
	            ...
	            <?php if ($_POST['subjection']==null): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2ketabtarjome" value="ثبت ارزیابی">
                    </p>
	            <?php elseif ($_POST['subjection']=='statet2'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2ketabtarjomeostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='schoolt2'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt2ketabtarjomemadrese" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='editt2k'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2ketabtarjome" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt2o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2ketabtarjomeostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt2m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt2ketabtarjomemadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t2/kt.js"></script>