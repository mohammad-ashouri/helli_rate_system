        ...
        <center>
            <table class="tabletafsili" >
                ...
                <tr>
                    ...
                    <td>
                        <input <?php if($_POST['subjection']=='log'){echo 'disabled';} ?> id="t2" type="number" step="any" name="t2" class="rate_inputs" onblur="calcular()" value="<?php if($_POST['subjection']=='log' or $_POST['subjection']=='editt3' or isset($_POST['tafsili3_ostan_log']) or isset($_POST['tafsili3_madrese_log'])){echo $tafsili3items['mizantasallotmosahehbarmozoo'];} ?><?php if ($_POST['subjection']=='editt3o' or $_POST['subjection']=='editt3m'){echo @$item['mizantasallotmosahehbarmozoo'];} ?>" >
                ...
                <tr>
                    ...
                    <td>
                        <input <?php if($_POST['subjection']=='log'){echo 'disabled';} ?> id="t3" type="number" step="any" name="t3" class="rate_inputs" onblur="calcular()" value="<?php if($_POST['subjection']=='log' or $_POST['subjection']=='editt3' or isset($_POST['tafsili3_ostan_log']) or isset($_POST['tafsili3_madrese_log'])){echo $tafsili3items['ahamiatvamobtanibarniazasar_matnmosaheh'];} ?><?php if ($_POST['subjection']=='editt3o' or $_POST['subjection']=='editt3m'){echo @$item['ahamiatvamobtanibarniazasar_matnmosaheh'];} ?>">
                        &nbsp;&nbsp;
                        از 4
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input <?php if($_POST['subjection']=='log'){echo 'disabled';} ?> id="t12" type="number" step="any" name="t12" class="rate_inputs" onblur="calcular()" value="<?php if($_POST['subjection']=='log' or $_POST['subjection']=='editt3' or isset($_POST['tafsili3_ostan_log']) or isset($_POST['tafsili3_madrese_log'])){echo $tafsili3items['nadashtanesabaeghetashih_matnmosaheh'];} ?><?php if ($_POST['subjection']=='editt3o' or $_POST['subjection']=='editt3m'){echo @$item['nadashtanesabaeghetashih_matnmosaheh'];} ?>">
                        &nbsp;&nbsp;
                        از 5
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input <?php if($_POST['subjection']=='log'){echo 'disabled';} ?> id="t13" type="number" step="any" name="t13" class="rate_inputs" onblur="calcular()" value="<?php if($_POST['subjection']=='log' or $_POST['subjection']=='editt3' or isset($_POST['tafsili3_ostan_log']) or isset($_POST['tafsili3_madrese_log'])){echo $tafsili3items['hajmmatnmosaheh'];} ?><?php if ($_POST['subjection']=='editt3o' or $_POST['subjection']=='editt3m'){echo @$item['hajmmatnmosaheh'];} ?>">
                        &nbsp;&nbsp;
                        از 4
                    </td>
                </tr>
            ...
            <center>
	            ...
	            <?php if ($_POST['subjection']==null): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtashih" value="ثبت ارزیابی">
                    </p>
	            <?php elseif ($_POST['subjection']=='statet3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtashihostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='schoolt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtashihmadrese" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='editt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtashih" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt3o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtashihostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt3m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input  onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtashihmadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t3/ktt.js"></script>