    ...
    <div class="box-body">
        ...
        <center>
            <table class="tabletafsili" >
                ...
                <tr>
                    <th>حجم متن ترجمه شده (حداقل 100 صفحه)</th>
                    <td>
            ...
            <center>
                ...
                <?php if ($_POST['subjection']==null or $_POST['subjection']=='subset'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtarjome" value="ثبت ارزیابی">
                    </p>
	            <?php elseif ($_POST['subjection']=='statet3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtarjomeostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='schoolt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3ketabtarjomemadrese" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='editt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtarjome" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt3o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtarjomeostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt3m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3ketabtarjomemadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t3/kt.js"></script>