        ...
        <center>
            ...
            <center>
	            ...
	            <?php elseif (@$_POST['subjection']=='statet3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3maghaleostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif(@$_POST['subjection']=='schoolt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt3maghalemadrese" value="ثبت ارزیابی">
                    </p>
	            <?php elseif(@$_POST['subjection']=='editt3'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3maghale" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt3o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input  onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3maghaleostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt3m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input  onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt3maghalemadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t3/m4.js"></script>