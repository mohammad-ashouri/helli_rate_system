        ...
        <center>
            <table class="tabletafsili" >
                ...
                <tr>
                    ...
                    <td>
                        <input value="<?php if ($_POST['subjection']=='editt1o' or $_POST['subjection']=='editt1m' or isset($_POST['tafsili1_ostan_log']) or isset($_POST['tafsili1_madrese_log'])){echo @$item['emtiazatvizheh'];} else {echo 0;} ?>" id="t13" type="number" step="any" name="t13" class="rate_inputs" onblur="calcular()">
                        &nbsp;&nbsp;
                        3+
                    </td>
                </tr>
            ...
            <center>
	            ...
	            <?php if ($_POST['subjection']==null): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt1ketabtarjome" value="ثبت ارزیابی">
                    </p>
	            <?php elseif ($_POST['subjection']=='statet1'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt1ketabtarjomeostani" value="ثبت ارزیابی">
                    </p>
	            <?php elseif($_POST['subjection']=='schoolt1'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="subt1ketabtarjomemadrese" value="ثبت ارزیابی">
                    </p>
                ...
                <?php elseif ($_POST['subjection']=='editt1o'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt1ketabtarjomeostani" value="ویرایش ارزیابی">
                    </p>
                <?php elseif ($_POST['subjection']=='editt1m'): ?>
                    <p class="virayesh-ejmali-button" >
                        <input onclick="return submitconfirm()" style="padding: 6px" type="submit" name="editt1ketabtarjomemadrese" value="ویرایش ارزیابی">
                    </p>
	            <?php endif; ?>
            </center>
...
<script src="build/js/rateforms/t1/kt.js"></script>