        ...
        <center>
            <table class="tabletafsili" >
                ...
                <tr>
                    ...
                    <td>
                        <input value="<?php if ($_POST['subjection']=='editt1o' or $_POST['subjection']=='editt1m'){echo @$item['adamreayatakhlaghpazhooheshi'];} else {echo 0;} ?>" id="t16" type="number" step="any" name="t16" style="width: 50px" onblur="calcular()" >
                        &nbsp;&nbsp;
                        5-
                    </td>
                </tr>
...
<script src="build/js/rateforms/t1/k1.js"></script>