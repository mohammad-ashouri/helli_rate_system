function validateForm() {
    ...
    var t16 = document.forms["myform"]["t16"].style.backgroundColor="white";
    ...
    var t16 = document.forms["myform"]["t16"].value;
    ...
    if (t1 == ""){
        ...
        document.forms["myform"]["t16"].style.backgroundColor="yellow";
        alert("فیلد شانزدهم وارد نشده است");
        return false;
    }
    if (t1 > 20){
        document.forms["myform"]["t1"].style.backgroundColor="yellow";
        alert("فیلد اول بیشتر از 20 وارد شده است");
        return false;
    }
    else if (t2 > 6){
        document.forms["myform"]["t2"].style.backgroundColor="yellow";
        alert("فیلد دوم بیشتر از 6 وارد شده است");
        return false;
    }
    else if (t3 > 7){
        document.forms["myform"]["t3"].style.backgroundColor="yellow";
        alert("فیلد سوم بیشتر از 7 وارد شده است");
        return false;
    }
    else if (t4 > 6){
        document.forms["myform"]["t4"].style.backgroundColor="yellow";
        alert("فیلد چهارم بیشتر از 6 وارد شده است");
        return false;
    }
    else if (t5 > 10){
        document.forms["myform"]["t5"].style.backgroundColor="yellow";
        ...
        document.forms["myform"]["t7"].style.backgroundColor="yellow";
        alert("فیلد هفتم بیشتر از 6 وارد شده است");
        return false;
    }
    else if (t8 > 20){
        document.forms["myform"]["t8"].style.backgroundColor="yellow";
        alert("فیلد هشتم بیشتر از 20 است");
        return false;
    }
    else if (t9 > 3){
        document.forms["myform"]["t9"].style.backgroundColor="yellow";
        alert("فیلد نهم بیشتر از 3 است");
        return false;
    }
    else if (t10 > 4){
        document.forms["myform"]["t10"].style.backgroundColor="yellow";
        alert("فیلد دهم بیشتر از 4 است");
        return false;
    }
    else if (t11 > 5){
        document.forms["myform"]["t11"].style.backgroundColor="yellow";
        ...
        document.forms["myform"]["t12"].style.backgroundColor="yellow";
        alert("فیلد دوازدهم بیشتر از 6 است");
        return false;
    }
    else if (t13 > 4){
        document.forms["myform"]["t13"].style.backgroundColor="yellow";
        alert("فیلد سیزدهم بیشتر از 4 است");
        return false;
    }
    else if (t14 > 3){
        document.forms["myform"]["t14"].style.backgroundColor="yellow";
        alert("فیلد چهاردهم بیشتر از 3 است");
        return false;
    }
    else if (t15 > 3){
        document.forms["myform"]["t15"].style.backgroundColor="yellow";
        alert("فیلد پانزدهم بیشتر از 3 است");
        return false;
    }
    else if (t16 > 5){
        document.forms["myform"]["t16"].style.backgroundColor="yellow";
        ...
        document.forms["myform"]["t15"].style.backgroundColor="yellow";
        alert("فیلد پانزدهم کمتر از 0 وارد شده است");
        return false;
    }
    else if (t16 < 0){
        document.forms["myform"]["t16"].style.backgroundColor="yellow";
...
function calcular() {
    ...
    document.getElementById('resultado').innerHTML = t1+t2+t3+t4+t5+t6+t7+t8+t9+t10+t11+t12+t13+t14+t15-t16;
}
