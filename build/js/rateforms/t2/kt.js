function validateForm() {
    ...
    if (t1 > 10){
        ...
        document.forms["myform"]["t2"].style.backgroundColor="yellow";
        alert("فیلد دوم بیشتر از 7 وارد شده است");
        return false;
    }
    else if (t3 > 5){
        document.forms["myform"]["t3"].style.backgroundColor="yellow";
        ...
        document.forms["myform"]["t4"].style.backgroundColor="yellow";
        alert("فیلد چهارم بیشتر از 4 وارد شده است");
        return false;
    }
    else if (t5 > 10){
        document.forms["myform"]["t5"].style.backgroundColor="yellow";
        ...
        document.forms["myform"]["t6"].style.backgroundColor="yellow";
        alert("فیلد ششم بیشتر از 11 وارد شده است");
        return false;
    }
    else if (t7 > 11){
        document.forms["myform"]["t7"].style.backgroundColor="yellow";
        alert("فیلد هفتم بیشتر از 11 وارد شده است");
        return false;
    }
    else if (t8 > 6){
        document.forms["myform"]["t8"].style.backgroundColor="yellow";
        alert("فیلد هشتم بیشتر از 6 وارد شده است");
        return false;
    }
    else if (t9 > 8){
        document.forms["myform"]["t9"].style.backgroundColor="yellow";
        alert("فیلد نهم بیشتر از 8 وارد شده است");
        return false;
    }
    else if (t10 > 10){
        document.forms["myform"]["t10"].style.backgroundColor="yellow";
        alert("فیلد دهم بیشتر از 10 وارد شده است");
        return false;
    }
    else if (t11 > 8){
        document.forms["myform"]["t11"].style.backgroundColor="yellow";
        alert("فیلد یازدهم بیشتر از 8 وارد شده است");
        return false;
    }
    else if (t12 > 10){
        document.forms["myform"]["t12"].style.backgroundColor="yellow";
        alert("فیلد دوازدهم بیشتر از 10 وارد شده است");
        return false;
    }
    else if (t13 > 3){
        document.forms["myform"]["t13"].style.backgroundColor="yellow";
        alert("فیلد سیزدهم بیشتر از 3 وارد شده است");
        return false;
    }
    else if (t1 < 0){
        document.forms["myform"]["t1"].style.backgroundColor="yellow";
...
function calcular() {
    ...
    document.getElementById('resultado').innerHTML = t1+t2+t3+t4+t5+t6+t7+t8+t9+t10+t11+t12+t13;
}
