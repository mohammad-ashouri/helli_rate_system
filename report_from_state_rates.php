        ...
        case 'همه استان‌ها':
            switch ($groupelmi){
                case 'همه گروه‌ها':
                    switch ($gender){
                        case 'بدون فیلتر':
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                        default:
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_p.gender='$gender' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                    }
                    break;
                default:
                    switch ($gender){
                        case 'بدون فیلتر':
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_a.groupelmi='$groupelmi' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                        default:
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_p.gender='$gender' and etelaat_a.groupelmi='$groupelmi' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                    }
                    break;
            }
        ...
        default:
            switch ($groupelmi){
                case 'همه گروه‌ها':
                    switch ($gender){
                        case 'بدون فیلتر':
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_p.ostantahsili='$state' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                        default:
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_p.gender='$gender' and etelaat_p.ostantahsili='$state' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                    }
                    break;
                default:
                    switch ($gender){
                        case 'بدون فیلتر':
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_a.groupelmi='$groupelmi' and etelaat_p.ostantahsili='$state' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                        default:
                            $sql="select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.jashnvareh='$jashnvareh' and etelaat_p.gender='$gender' and etelaat_a.groupelmi='$groupelmi' and etelaat_p.ostantahsili='$state' order by etelaat_a.jamemtiazostan desc,etelaat_a.nobat_arzyabi_ostani desc";
                            break;
                    }
                    break;
            }
                                    ...
                                    <tr style="font-size: 15px;border-bottom: 2px solid black" >
                                        ...
                                        <td style="padding: 10px">
                                            <?php
                                                ...
                                                elseif ($values['vaziatmadreseasar']=='انتقال از استان'){
                                                    echo 'انتقال به مدرسه';
                                                }
                                                else{
