...
if ($_SESSION['head'] == 1 or $_SESSION['head'] == 2 or $_SESSION['head'] == 3):
    ...
    <div class="row">
        <section class="col-lg-12 col-md-12">
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    if (isset($_POST['submit']) and !empty($_POST['codeasar'])):
                        ...
                        $et_a = mysqli_fetch_array($result_a);
                        $et_p = mysqli_fetch_array($result_p);
                        ?>
                    <?php endif; ?>
                </div>
            </div>
            <?php if ($et_a != null and $et_p != null and isset($_POST['submit'])): ?>
                <section class="content">
                    <div class="row">
                        ...
                        <?php if ($et_a['noefaaliat'] == 'مشترک'): ?>
                            <section class="col-lg-12 col-md-12">
                                <div class="box box-solid box-success">
                                    <div class="box-header">
                                        <i class="fa fa-info-circle"></i>
                                        <h3 class='box-title'>اطلاعات مشترکین اثر</h3>
                                    </div>
                                    <div class="box-body">
                                        <table class="table text-center">
                                            ...
                                            <?php
                                            $query = mysqli_query($connection, "select * from participants where codeasar=$codeasar");
                                            foreach ($query as $key => $participants):
                                                ?>
                                                <tr>
                                                    <td><?php echo ++$key; ?></td>
                                                    <td><?php echo "$participants[name] $participants[family]"; ?></td>
                                                    <td><?php echo "$participants[national_code]"; ?></td>
                                                    <td><?php echo "$participants[participation_percentage]"; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </table>
                                    </div>
                        ...
                        <?php if ($_SESSION['head'] == 1): ?>
                            <section class="col-lg-12 col-md-12">
                                <div class="box box-solid box-success">
                                    <div class="box-header">
                                        <i class="fa fa-info-circle"></i>
                                        <h3 class='box-title'>اطلاعات ارزیابی کشوری</h3>
                                    </div>
                                    <div class="box-body">
                                        ...
                                        if (@$tafsili2 != '' and @$tafsili2 != null and @$tafsili2['jam'] != null): ?>
                                            <form target="_blank" action="tafsili2.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                     امتیاز:
                                                     <?php echo $tafsili2['jam'] ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                     ارزیاب:
                                                     <?php
                                                     $tafsili2_rater = $tafsili2['rater_id'];
                                                     $query = mysqli_query($connection, "select * from rater_list where username='$tafsili2_rater'");
                                                     foreach ($query as $tafsili2_rater_info) {

                                                     }
                                                     echo 'استاد ' . $tafsili2_rater_info['name'] . ' ' . $tafsili2_rater_info['family'];
                                                     ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                     تاریخ ارزیابی:
                                                    <?php echo $tafsili2['datesabt'] ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                    <input name="subjection" value="log" type="hidden">
                                        ...
                                        if (@$tafsili3 != '' and @$tafsili3 != null and @$tafsili3['jam'] != null): ?>
                                            <form target="_blank" action="tafsili3.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                     امتیاز:
                                                     <?php echo $tafsili3['jam'] ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                     ارزیاب:
                                                     <?php
                                                     $tafsili3_rater = $tafsili3['rater_id'];
                                                     $query = mysqli_query($connection, "select * from rater_list where username='$tafsili3_rater'");
                                                     foreach ($query as $tafsili3_rater_info) {

                                                     }
                                                     echo 'استاد ' . $tafsili3_rater_info['name'] . ' ' . $tafsili3_rater_info['family'];
                                                     ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                     تاریخ ارزیابی:
                                                    <?php echo $tafsili3['datesabt'] ?>
                                                 </span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="font-weight: bold">
                                                    <input name="subjection" value="log" type="hidden">
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="log">مشاهده ریز نمرات ارزیابی تفصیلی سوم</button>
                                                </span>
                                            </form>
                                        <?php endif; ?>
                                    </div>
                                            ...
                                            <form target="_blank" action="tafsili1.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="tafsili1_ostan_log">مشاهده ریز نمرات ارزیابی تفصیلی اول</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php
                                            ...
                                            <form target="_blank" action="tafsili2.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="tafsili2_ostan_log">مشاهده ریز نمرات ارزیابی تفصیلی دوم</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php
                        ...
                        $checkmadresehaverate = mysqli_fetch_array($query);
                                            ...
                                            <form target="_blank" action="sabt-arzyabi-ejmali.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="code" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="ejmali_madrese_log">مشاهده ریز نمرات ارزیابی اجمالی</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php
                                            ...
                                            <form target="_blank" action="/tafsili1.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="tafsili1_madrese_log">مشاهده ریز نمرات ارزیابی تفصیلی اول</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php
                                            ...
                                            <form target="_blank" action="/tafsili2.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="tafisli2_madrese_log">مشاهده ریز نمرات ارزیابی تفصیلی دوم</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php
                                            ...
                                            <form target="_blank" action="/tafsili3.php" method="post">
                                                ...
                                                <span style="font-weight: bold">
                                                    ...
                                                    <input name="codeasar" value="<?php echo $codeasar ?>"
                                                        ...
                                                        <button class="btn btn-block btn-success"
                                                                style="width: 250px; display: inline"
                                                                name="tafsili3_madrese_log">مشاهده ریز نمرات ارزیابی تفصیلی سوم</button>
                                                </span>
                                            </form>
                                            <hr>
                                        <?php endif; ?>
                ...
                <?php if ($et_p['master']=='هست'): ?>
                    <section class="col-lg-12 col-md-12">
                        <div class="box box-solid box-success">
                            <div class="box-header">
                                <i class="fa fa-info-circle"></i>
                                <h3 class='box-title'>اطلاعات تدریس</h3>
                            </div>
                            <div class="box-body">
                                <table class="table text-center">
                                    <tr>
                                    ...
                                    <tr>
                                        <td><?php echo $et_p['mastercode'] ?></td>
                                        <td><?php echo $et_p['teachingProvince'] ?></td>
                                        <td><?php echo $et_p['teachingCity'] ?></td>
                                        <td><?php echo $et_p['teachingPlaceName'] ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="box box-solid box-success">
                                ...
                                <div class="box-body" style="text-align: center">
                                    ...
                                    if (strlen(@$et_a['fileasar']) > 28):
                                        ...
                                        <a target="_blank"
                                           href="<?php
                                           if (substr($et_a['fileasar'], 0, 5) !== "https") {
                                               if ($et_a['fileasar'] != 'dist/files/asar_files/') {
                                                   echo $main_website_url . @$et_a['fileasar'];
                                               }
                                           } else {
                                               if (substr($et_a['fileasar'], 0, 5) === "https") {
                                                   echo @$et_a['fileasar'];
                                    ...
                                    <?php endif; ?>
                                    <?php
                                    if (isset($et_a['fileasar_word']) and strlen($et_a['fileasar_word']) > 28):
                                        ?>
                                    ...
                                    <?php endif; ?>
                                    <?php
                                    if (isset($et_a['filetafsili1_ostan']) and strlen($et_a['filetafsili1_ostan']) > 28):
                                        ?>
                                    ...
                                    <?php endif; ?>
                                    <?php
                                    if (isset($et_a['filetafsili2_ostan']) and strlen($et_a['filetafsili2_ostan']) > 28):
                                        ?>
                                    ...
                                    <?php endif; ?>
                                    <?php
                                    if (strlen(isset($et_a['filetafsili3_ostan']) and $et_a['filetafsili3_ostan']) > 28):
                                        ?>
            ...
            <?php elseif (!isset($_POST['submit']) or empty($et_a)): ?>
                <div class="row">
                    <section class="col-lg-12 col-md-12">
                                ...
                                <div class="box box-solid box-success ">
                                    <div class="box-header ">
                                        ...
                                        <h3 class='box-title'>اطلاعات صاحب اثر با کد
                                            ملی <?php echo $codemelli = $et_p['codemelli']; ?>
                                        </h3>
                                        <?php
                                        if ($_SESSION['head'] == 1):
                                            $query = mysqli_query($signup_connection, "select * from users inner join user_activity_logs on users.id=user_activity_logs.user_id where users.national_code='$codemelli' and user_activity_logs.activity like '%Login With Token %'");
                                            ...
                                            <div class="box-body">
                                                <table class="table_p_info">
                                                    ...
                                                    foreach ($result_p as $et_p):
                                                        ...
                                                        $result_h = mysqli_query($connection, "select * from etelaat_a where `codeasar`='$codeasar'");
                                                        foreach ($result_h as $et_h): ?>
                                                            <tr>
                                                                <td><?php echo $et_h['codeasar']; ?></td>
                                                                <td style="padding-right: 15px">
                                                                    <label style="font-weight: normal">
                                                                        <?php echo $et_h['jashnvareh']; ?>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if (substr($et_h['fileasar'], 0, 5) !== "https") {
                                                                        if ($et_h['fileasar'] != 'dist/files/asar_files/') {
                                                                            echo $main_website_url . @$et_h['fileasar'];
                                                                        }
                                                                    } else {
                                                                        if (substr($et_h['fileasar'], 0, 5) === "https") {
                                                                            echo @$et_h['fileasar'];
                                                                    ...
                                                                    if (strlen(@$et_h['fileasar_word']) > 28) {
                                                                        echo $main_website_url . @$et_h['fileasar_word'];
                                                                    }

                                                                    ?>">
                                                                        <?php echo $et_a['fileasar']; ?>
                                                                        لینک فایل اثر
                                                                    </a>
