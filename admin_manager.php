...
<!--                            </form>-->
                    ...
                    <div class="box-body">
                            ...
                            <form id="myform" onsubmit="return validateForm()" method="post" action="build/php/inc.php">
                                ...
                                <input type="text" name="ratercode" id="ratercode" placeholder="کد را وارد کنید" style="padding: 5px;border-radius: 5px">
                                <input type="submit" value="جستجو" name="subsearchadmin" style="padding: 7px;border-radius: 5px">
                            </form>
                            <br/>
                        ...
                        <center>
                                <table class="tableratermanager">
                                    ...
                                    <tr>
                                        <th>رمز عبور</th>
                                        <td><input value="<?php if (isset($_POST['subsearchadmin'])) {} else {echo 123456;}?>" id="password" class="inputratermanager" type="text" name="password"></td>
                                    </tr>
                                    <tr>
                                        <th>نام</th>
                                ...
                                <br/>
                                    <input name="setadmin" class="set" type="submit" value="ثبت" onclick="return confirm('کاربر گرامی: لطفا در صورت صحت اطلاعات ادمین جدید، بر روی گزینه OK کلیک کنید')">
                            ...
                            <form action="build/php/inc.php" method="post">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" value="<?php echo $raters['code'] ?>" name="keshvariadmincode">
                                        <input type="submit" style="padding: 7px" value="<?php if ($raters['approved']==1){ echo "غیرفعال";}else{echo "فعال";} ?>" name="<?php if ($raters['approved']==1){ echo "disableadmin";}else{echo "enableadmin";} ?>">
                                    </td>
                                </tr>
