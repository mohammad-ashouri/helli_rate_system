				...
				<div class="box-body" style="overflow-x: auto">
					...
					<div class="row">
						<?php
							switch ($city_name){
								case 'کاشان':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_ostani is not null and etelaat_a.codearzyabejmali_ostani!='' and etelaat_p.shahrtahsili='کاشان' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='ارزیابی اجمالی' order by etelaat_a.groupelmi asc");
									break;
								case 'بناب':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_ostani is not null and etelaat_a.codearzyabejmali_ostani!='' and etelaat_p.shahrtahsili='بناب' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='ارزیابی اجمالی' order by etelaat_a.groupelmi asc");
									break;
								default:
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_ostani is not null and etelaat_a.codearzyabejmali_ostani!='' and etelaat_p.ostantahsili='$state' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='ارزیابی اجمالی' and etelaat_p.shahrtahsili!='بناب' and etelaat_p.shahrtahsili!='کاشان' order by etelaat_a.groupelmi asc");
									break;
							}             ?>
				...
				<div class="box-body" style="overflow-x: auto">
					...
					<div class="row">
						<?php
							switch ($city_name){
								case 'کاشان':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_ostani is not null and etelaat_a.codearzyabtafsili1_ostani!='' and etelaat_p.shahrtahsili='کاشان' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='تفصیلی اول' order by etelaat_a.groupelmi asc");
									break;
								case 'بناب':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_ostani is not null and etelaat_a.codearzyabtafsili1_ostani!='' and etelaat_p.shahrtahsili='بناب' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='تفصیلی اول' order by etelaat_a.groupelmi asc");
									break;
								default:
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_ostani is not null and etelaat_a.codearzyabtafsili1_ostani!='' and etelaat_p.ostantahsili='$state' and etelaat_a.vaziatkarnameostani='در حال ارزیابی' and nobat_arzyabi_ostani='تفصیلی اول' and etelaat_p.shahrtahsili!='بناب' and etelaat_p.shahrtahsili!='کاشان' order by etelaat_a.groupelmi asc");
									break;
							}
							 ?>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <form action="sabt-arzyabi-ejmali.php" method="post">
                                            ...
                                            <input type="hidden" name="coderater" value="<?php echo $_SESSION['coderater']; ?>">
