				...
				<div class="box-body" style="overflow-x: auto">
					...
					<div class="row">
						<?php
                            switch ($city_name){
                                case 'کاشان':
	                                $query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_madrese is not null and etelaat_a.codearzyabejmali_madrese!='' and etelaat_p.shahrtahsili='کاشان' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='ارزیابی اجمالی' order by etelaat_a.groupelmi asc");
	                                break;
                                case 'بناب':
	                                $query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_madrese is not null and etelaat_a.codearzyabejmali_madrese!='' and etelaat_p.shahrtahsili='بناب' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='ارزیابی اجمالی' order by etelaat_a.groupelmi asc");
	                                break;
                                default:
	                                $query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabejmali_madrese is not null and etelaat_a.codearzyabejmali_madrese!='' and etelaat_a.codearzyabejmali_madrese!='' and etelaat_p.ostantahsili='$state_name' and etelaat_p.shahrtahsili='$city_name' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='ارزیابی اجمالی' and etelaat_p.shahrtahsili!='بناب' and etelaat_p.shahrtahsili!='کاشان' order by etelaat_a.groupelmi asc");
	                                break;
                            }
 ?>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="myinputelmigroup" onkeyup="searchelmigroup()" placeholder="جستجو در گروه علمی" title="جستجو در گروه علمی">
						...
						<table id="myTable2" class="arzyabinashodetable">
								...
								foreach ($query as $ejmalinotrated):
									...
									<tr>
										...
										<td><?php $coderater=$ejmalinotrated['codearzyabejmali_madrese']?></td>
										<td><?php
										...
										<td><?php echo $ejmalinotrated['groupelmi'];$ejmalinotrated['codearzyabejmali_madrese']=null; ?></td>
									</tr>
				...
				<div class="box-body" style="overflow-x: auto">
					...
					<div class="row">
						<?php
							switch ($city_name){
								case 'کاشان':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_madrese is not null and etelaat_a.codearzyabtafsili1_madrese!='' and etelaat_p.shahrtahsili='کاشان' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='تفصیلی اول' order by etelaat_a.groupelmi asc");
									break;
								case 'بناب':
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_madrese is not null and etelaat_a.codearzyabtafsili1_madrese!='' and etelaat_p.shahrtahsili='بناب' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='تفصیلی اول' order by etelaat_a.groupelmi asc");
									break;
								default:
									$query = mysqli_query($connection, "select * from etelaat_a inner join etelaat_p on etelaat_a.codeasar=etelaat_p.codeasar where etelaat_a.codearzyabtafsili1_madrese is not null and etelaat_a.codearzyabtafsili1_madrese!='' and etelaat_p.ostantahsili='$state_name' and etelaat_p.shahrtahsili='$city_name' and etelaat_p.madrese='$school_name' and etelaat_a.vaziatkarnamemadrese='در حال ارزیابی' and nobat_arzyabi_madrese='تفصیلی اول' and etelaat_p.shahrtahsili!='بناب' and etelaat_p.shahrtahsili!='کاشان' order by etelaat_a.groupelmi asc");
									break;
							}
							 ?>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<?php
								...
								foreach ($query as $tafsili1notrated):
									...
									<tr>
										...
										<td><?php echo  $tafsili1notrated['codearzyabtafsili1_madrese']?></td>
										<td><?php
												$coderater=$tafsili1notrated['codearzyabtafsili1_madrese'];
												$query=mysqli_query($connection,"select * from rater_list where code='$coderater'");
												foreach ($query as $raterinfo){}
												echo  $raterinfo['name'].' '.$raterinfo['family'];?></td>
							...
							<?php
								...
								foreach ($query as $tafsili2notrated):
									...
									<tr>
										...
										<td><?php echo  $tafsili2notrated['codearzyabtafsili2_madrese']?></td>
										<td><?php
												$coderater=$tafsili2notrated['codearzyabtafsili2_madrese'];
												$query=mysqli_query($connection,"select * from rater_list where code='$coderater'");
												foreach ($query as $raterinfo){}
												echo  $raterinfo['name'].' '.$raterinfo['family'];?></td>
							...
							<?php
								...
								foreach ($query as $tafsili3notrated):
									...
									<tr>
										...
										<td><?php echo  $tafsili3notrated['codearzyabtafsili3_madrese']?></td>
										<td><?php
												$coderater=$tafsili3notrated['codearzyabtafsili3_madrese'];
												$query=mysqli_query($connection,"select * from rater_list where code='$coderater'");
												foreach ($query as $raterinfo){}
												echo  $raterinfo['name'].' '.$raterinfo['family'];?></td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <form action="sabt-arzyabi-ejmali.php" method="post">
                                            <a style="width: available" target="_blank" href="<?php if ($meitems['fileasar']=='dist/files/asar_files/'){echo $meitems['fileasar_word'];} else {echo $meitems['fileasar'];} ?>">
                                                <label style="width: auto"><?php echo $a."- ".$meitems['nameasar']; $a++;?></label>
                                            </a>
                                            <br/>
                                            <label style="width: 90%;"><?php
                                                echo $meitems['ghalebpazhouhesh']." سطح ".$meitems['satharzyabi']."<br>"." گروه علمی ".$meitems['groupelmi'] ?></label>
                                            <br/><br/>
                                            <input type="hidden" name="code" value="<?php echo $meitems['codeasar']; ?>">
                                            <input type="hidden" name="subjection" value="schoolejmali">
                                            <input type="hidden" name="coderater" value="<?php echo $_SESSION['username']; ?>">

                                            <input style="padding: 5px" name="submit" type="submit" value="ثبت ارزیابی اجمالی">
                                        </form>
                            ...
                            foreach ($resultoe as $oeitems):               ?>
                                <tr>
                                    <td>
                                        ...
                                        <form action="sabt-arzyabi-ejmali.php" method="post">
                                            <a style="width: available" target="_blank" href="<?php if ($oeitems['fileasar']=='dist/files/asar_files/'){echo $oeitems['fileasar_word'];} else {echo $oeitems['fileasar'];} ?>">
                                                <label style="width: auto"><?php echo $a."- ".$oeitems['nameasar']; $a++;?></label>
                                            </a>
                                            <br/>
                                            <label style="width: 90%;"><?php
                                                echo $oeitems['ghalebpazhouhesh']." سطح ".$oeitems['satharzyabi']."<br>"." گروه علمی ".$oeitems['groupelmi'] ?></label>
                                            <br/><br/>
                                            <input type="hidden" name="code" value="<?php echo $oeitems['codeasar']; ?>">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <form action="tafsili1.php" method="post">
                                                    <a style="width: available" target="_blank" href="<?php if ($bin['fileasar']=='dist/files/asar_files/'){echo $bin['fileasar_word'];} else {echo $bin['fileasar'];} ?>">
                                                        <label style="width: auto"><?php echo $a."- ".$bin['nameasar']; $a++;?></label>
                                                    </a>
                                                    <br/>
                                                    <label style="width: 90%;"><?php
                                                        echo $bin['ghalebpazhouhesh']." سطح ".$bin['satharzyabi']."<br>"." گروه علمی ".$bin['groupelmi'] ?></label>
                                                    <br/><br/>
                                                    <input type="hidden" name="subset" value="<?php echo $bin['codeasar']; ?>">
                                                    <input type="hidden" name="coderater" value="<?php echo $_SESSION['username']; ?>">
                                                    <input type="hidden" name="subjection" value="schoolt1">

                                                    <input style="padding: 5px" name="submit" type="submit" value="ثبت ارزیابی تفصیلی">
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
